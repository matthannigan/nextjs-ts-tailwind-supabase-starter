...
## Background
I need to create comprehensive documentation for the [Component Name] component that follows our project's standardized format. This component was integrated from shadcn/ui into our Next.js TypeScript TailwindCSS Supabase starter project.

## Component Research
1. First, fetch the fetch the official Shadcn UI Button documentation from `https://ui.shadcn.com/docs/components/[Component Name]` and Brave Web Search "shadcn ui [Component Name] component documentation usage examples properties limitations" to understand:
...
2. Then, examine our project's implementation:
   - Look at our source code at `/src/components/ui/[Component Name].tsx`
...
1. Use our template at `/docs/components/component-documentation-template.md` as your base structure.

2. Create new or update the existing markdown file at `/docs/components/ui/[Component Name].md` (or within the appropriate subdirectory).

3. Complete each section of the template with specific information:
...
4. Add react-hook-form integration examples where applicable, as our project uses this library.

5. Include any shadcn/ui installation commands if the component requires additional dependencies.
...
2. Examine our existing template at `/docs/testing/tool-documentation-template.md` to understand the required structure.
