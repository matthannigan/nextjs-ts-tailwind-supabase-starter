...
def extract_prompt_template(prompts_file_path):
    """Extract the Components prompt template from the documentation-prompts.md file."""
    ...
    if ui_section_match:
        ...
        print("Error: Could not find Components template in documentation-prompts.md")
        sys.exit(1)
...
def main():
    ...
    docs_dir = base_dir / "docs-website" / "docs" / "components"
    prompts_file = base_dir / "docs-website" / "docs" / "developer-guide" / "prompts" / "documentation-prompts.md"
