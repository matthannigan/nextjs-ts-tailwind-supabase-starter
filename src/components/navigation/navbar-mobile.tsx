...
const NavItem: FC<NavItemProps> = ({ href, icon, label }) => {
  ...
  return (
    ...
    >
      <div className={`w-5 h-5 mb-2 ${isActive ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500'}`}>
        {icon}
      </div>
      <span 
